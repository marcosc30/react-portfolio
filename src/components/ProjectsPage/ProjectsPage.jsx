      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className={styles.project2}>
          <div className={styles.project2_pic}>
            ...
            <a href='projects/isomorphisms'>Link to full project page</a>
        </div>
        <div className={styles.project1}>
            <div className={styles.project1_pic}>
        ...
        <div className={styles.project1}>
            ...
            <a href='projects/manyshot'> Link to full project page</a>
        </div>
        <div className={styles.project2}>
          <div className={styles.project2_pic}>
            ...
            <a href='projects/blockscapes'>Link to full project page</a>
        </div>
        <div className={styles.project1}>
            <div className={styles.project1_pic}>
            ...
            <a href='projects/quadsieve'> Link to full project page</a>
        </div>
      </div>
    );
  }
